...
Partial Class MainForm
    ...
    Private Sub InitializeComponent()
        ...
        tbLogOutput.Size = New Size(1511, 1295)
        ...
        ssMain.Location = New Point(0, 1359)
        ssMain.Name = "ssMain"
        ssMain.Padding = New Padding(1, 0, 10, 0)
        ssMain.Size = New Size(1974, 24)
        ssMain.TabIndex = 4
        ...
        tsslRunning.Size = New Size(17, 19)
        tsslRunning.Text = "l"
        ' 
        ' tsslMain
        ' 
        tsslMain.Name = "tsslMain"
        tsslMain.Size = New Size(22, 19)
        tsslMain.Text = "---"
        ' 
        ' tspbMain
        ' 
        ...
        ToolStripStatusLabel1.Size = New Size(10, 19)
        ToolStripStatusLabel1.Text = "|"
        ' 
        ' tspbMultiFile
        ' 
        tspbMultiFile.Name = "tspbMultiFile"
        tspbMultiFile.Size = New Size(117, 18)
        ' 
        ' tsslMultiFile
        ' 
        tsslMultiFile.Name = "tsslMultiFile"
        tsslMultiFile.Size = New Size(22, 19)
        tsslMultiFile.Text = "---"
        ' 
        ' pgMain
        ' 
        ...
        gbDetails.Size = New Size(430, 638)
        ...
        tbDetails.Size = New Size(415, 609)
        ...
        scMain.Size = New Size(1946, 1295)
        scMain.SplitterDistance = 430
