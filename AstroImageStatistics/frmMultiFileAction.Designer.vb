...
Partial Class frmMultiFileAction
    ...
    Private Sub InitializeComponent()
        ...
        tsmiFileList_ResetDeltaX = New ToolStripMenuItem()
        tsmiFileList_ResetDeltaY = New ToolStripMenuItem()
        tsmiFileList_ResetProcess = New ToolStripMenuItem()
        ...
        cmsTable_CopyDeltaXYDown = New ToolStripMenuItem()
        ...
        ' cmsTable
        ' 
        cmsTable.Items.AddRange(New ToolStripItem() {cmsTable_OpenFile, cmsTable_MoveToBad, cmsTable_CopyDeltaXYDown})
        cmsTable.Name = "cmsTable"
        cmsTable.Size = New Size(232, 92)
        ' 
        ' cmsTable_OpenFile
        ' 
        cmsTable_OpenFile.Name = "cmsTable_OpenFile"
        cmsTable_OpenFile.Size = New Size(231, 22)
        cmsTable_OpenFile.Text = "Open file"
        ' 
        ' cmsTable_MoveToBad
        ' 
        cmsTable_MoveToBad.Name = "cmsTable_MoveToBad"
        cmsTable_MoveToBad.Size = New Size(231, 22)
        ...
        scButtom.Size = New Size(1527, 624)
        ...
        scBottomRight.Size = New Size(1036, 618)
        scBottomRight.SplitterDistance = 298
        ...
        gbAspects.Size = New Size(1027, 292)
        ...
        tcAspect.Size = New Size(1020, 263)
        tcAspect.TabIndex = 0
        ' 
        ' tpFITSHeader
        ' 
        ...
        tpFITSHeader.Size = New Size(1012, 235)
        ...
        tbFITSHeader.Size = New Size(1004, 229)
        ...
        tbCombinedROI.Size = New Size(1013, 236)
        ...
        pbImage.Size = New Size(1003, 225)
        ...
        tbSinglePixelStat.Size = New Size(1013, 236)
        ...
        zgcSinglePixelStat.Size = New Size(544, 221)
        ...
        tbPixelStat.Size = New Size(446, 221)
        ...
        ' tsmiFileList
        ' 
        tsmiFileList.DropDownItems.AddRange(New ToolStripItem() {tsmiFileList_ClearList, tsmiFileList_ResetDeltaX, tsmiFileList_ResetDeltaY, tsmiFileList_ResetProcess})
        ...
        ' 
        ' tsmiFileList_ResetDeltaX
        ' 
        tsmiFileList_ResetDeltaX.Name = "tsmiFileList_ResetDeltaX"
        tsmiFileList_ResetDeltaX.Size = New Size(180, 22)
        tsmiFileList_ResetDeltaX.Text = "Reset - DeltaX"
        ' 
        ' tsmiFileList_ResetDeltaY
        ' 
        tsmiFileList_ResetDeltaY.Name = "tsmiFileList_ResetDeltaY"
        tsmiFileList_ResetDeltaY.Size = New Size(180, 22)
        tsmiFileList_ResetDeltaY.Text = "Reset - DeltaY"
        ' 
        ' tsmiFileList_ResetProcess
        ' 
        tsmiFileList_ResetProcess.Name = "tsmiFileList_ResetProcess"
        tsmiFileList_ResetProcess.Size = New Size(180, 22)
        tsmiFileList_ResetProcess.Text = "Reset - Process"
        ' 
        ' tsmiAction
        ' 
        ...
        ' 
        ' cmsTable_CopyDeltaXYDown
        ' 
        cmsTable_CopyDeltaXYDown.Name = "cmsTable_CopyDeltaXYDown"
        cmsTable_CopyDeltaXYDown.Size = New Size(231, 22)
        cmsTable_CopyDeltaXYDown.Text = "Copy DeltaXY to all lower files"
        ' 
        ' frmMultiFileAction
        ' 
    ...
    Friend WithEvents tsmiFileList_ResetDeltaX As ToolStripMenuItem
    Friend WithEvents tsmiFileList_ResetDeltaY As ToolStripMenuItem
    Friend WithEvents tsmiFileList_ResetProcess As ToolStripMenuItem
    Friend WithEvents cmsTable_CopyDeltaXYDown As ToolStripMenuItem
End Class
